...
urlpatterns = [
    ...
    re_path(r'^productpricenames/$', views.ProductPriceNameListView.as_view(), name='product_prices'),
    re_path(r'^productpricenames/product_price_create/$', views.ProductPriceNameCreateView.as_view(), name='product_price_create'),
    re_path(r'^productpricenames/product_price_edit/(?P<pk>\d+)$', views.ProductPriceNameEditView.as_view(), name='product_price_edit'),
